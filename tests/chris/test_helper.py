...
def test_generic_of():
    assert generic_of(AnonymousChrisStoreClient, CommonCollectionLinks) is AnonymousCollectionLinks
    assert generic_of(ChrisStoreClient, CommonCollectionLinks) is StoreCollectionLinks
    assert generic_of(ChrisStoreClient, AuthenticatedCollectionLinks) is StoreCollectionLinks
    ...
    assert generic_of(CreateUsersTask[ChrisStoreClient], AuthenticatedClient) is ChrisStoreClient
